...
def test_parse_results_differing_sums() -> None:
...
def test_parse_results_measured_scenario_with_warmup() -> None:
    content = """# CFG lang=rust scenario=spst M=B ALLOC=allocate N=2000000 K=64 I=8 P=1 T=1 RING=1024 S=3/2
RESULT 15000000 500.0
RESULT 14000000 500.0
RESULT 13000000 500.0
---
RESULT 10000000 500.0
RESULT 11000000 500.0
# CFG lang=rust scenario=spst M=A ALLOC=pool N=2000000 K=64 I=8 P=1 T=1 RING=1024 S=3/2
RESULT 18000000 500.0
RESULT 17000000 500.0
RESULT 16000000 500.0
---
RESULT 8000000 500.0
RESULT 9000000 500.0
"""
